...
#include "ZPlayerExtensionScope.generated.h"

UCLASS()
class ZEROEXTENSIONSYSTEMRUNTIME_API UZPlayerExtensionScope : public ULocalPlayerSubsystem, public IZExtensionScope
{
	GENERATED_BODY()
